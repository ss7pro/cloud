...
class KeystoneAPIClient(httplib2.Http):
	...
	def __init__(self,timeout=1):
		...
		self.tenant = 'admin'
		self.admin_token = 'nu3ehuOAmSLS03EHFX8Dil3rDzvctTRY'
		self.auth_url = 'http://10.76.0.204:5000/v2.0'
		self.admin_auth_url = 'http://10.76.0.204:35357/v2.0'
...
#
	...
	def keystone_admin_request(self,url=None,body=None,method=None):
		...
		try:
			...
			return self.encapsulate_resp(r,b,where='keystone_create_admin_reques at: ' + url,msg='JSON deserialization error',status='400')
